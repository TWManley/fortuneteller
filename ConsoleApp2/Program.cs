...
namespace Fortune
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("you will have 10 dollars!");
            }
            ...
            Console.WriteLine("{0} {1} you will retire in {2} years with {3} dollars in the bank and a vacation home in {4} your mode of trtiansport will be{5}", firstname,lastname,moneyResult, birthmonth,numberofsiblings,favoritecolor);
